...
export default function Header() {
  ...
  return (
    <header className="absolute top-10 md:top-15 left-0 w-full z-[100] bg-transparent px-7 md:px-0 ">
      <div className="max-w-[57rem] mx-auto rounded-xl">
        <div className="flex items-center justify-between border-2 border-[#b89c6c] rounded-xl px-4 md:px-9 py-2 md:py-4 hover:bg-[#b89c6c] transition-colors duration-500 group cabecalho">
          {/* Logo à esquerda */}
          <Link href="/" className="flex items-center">
            <Image
              src="/images/header/logo-header-1.webp"
              alt="Hyllua Husein"
              width={140}
              height={34}
            ...
            />
            <Image
              src="/images/header/logo-header-hover-1.webp"
          ...
          <nav className="hidden md:flex flex-1 justify-center">
            <ul className="flex gap-8 items-center">
              ...
              <li>
                <Link href="/ensino" className="primary-color texto-montrea font-medium text-[0.73rem] hover:underline transition uppercase tracking-wide group-hover:text-[#f7eccd]">
                  ENSINO
                </Link>
              </li>
              <li>
                <Link href="/hyllua-beauty" className="primary-color texto-montrea font-medium text-[0.73rem] hover:underline transition uppercase tracking-wide group-hover:text-[#f7eccd]">
                  HYLLUA BEAUTY
                </Link>
              </li>
              <li>
                <Link href="/blog" className="primary-color texto-montrea font-medium text-[0.73rem] hover:underline transition uppercase tracking-wide group-hover:text-[#f7eccd]">
                  BLOG
                </Link>
              </li>
            </ul>
