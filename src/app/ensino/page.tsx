...
export default function EnsinoSections() {
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center items-center lg:items-start px-6 lg:px-0">
            <div className="max-w-md">
              <div className="flex items-start gap-2 justify-center lg:justify-start relative lg:-left-3 ">
                ...
                <div className="titulo-scotch font-bold italic text-white text-[70px] lg:text-[120px] leading-none relative -bottom-6 lg:-top-8.5 lg:ml-1">ética</div>
              </div>
              <p className="lg:text-[1rem] text-[1.15rem]  top-7  tracking-wide text-white mb-8 lg:mb-8 font-light leading-none  text-right relative  lg:-right-37 lg:-top-7   lg:w-[16rem]">
  ...
  <div className="max-w-4xl w-full flex flex-col lg:flex-row items-center lg:items-start justify-center gap-6 text-center lg:text-left mb-5">
    ...
    <div className="flex flex-1 flex-col items-center lg:items-start titulo-scotch">
      <p className="text-[#3957a6] font-normal text-[0.85rem] lg:text-[1.4rem] self-start leading-none -right-0 top-1 relative lg:-right-2.5 lg:top-2">A prática precisa</p>
      <h2 className="font-bold italic text-[#3957a6] text-[33px] lg:text-[66px] leading-none">acompanhar</h2>
      <span className="text-[#3957a6] font-normal text-[0.85rem] lg:text-[1.4rem] mb-4 self-end lg:-left-31 lg:-top-1 relative">o conhecimento</span>
    </div>
    {/* Balão azul */}
    <div className="bg-[#3957a6]  lg:w-full text-white rounded-[0.8rem] lg:px-10 px-4 py-2 lg:py-4 text-[0.85rem] lg:text-[1.3rem] font-light leading-4 lg:leading-[1.5]  mb-4 lg:mb-0 max-w-[20rem] mx-auto lg:mx-0 text-center lg:-left-12 relative z-3 -top-4" >
...
<div className="absolute  right-[-280px] bottom-[-220px] lg:right-[-190px] lg:bottom-[-400px] z-2">
  ...
  <section className="w-full bg-[url('/images/ensino/background-textura-wonderfull-face.webp')] bg-contain bg-repeat pt-10 pb-4 px-0 flex flex-col items-center justify-center relative ">
    <div className="w-full flex justify-center items-end relative z-3 -top-42 lg:-top-58 -right-10 lg:-right-9">
     ...
     <div className="absolute inset-y-5 lg:inset-y-26 right-0 w-1/2 z-4 lg:mt-66 mt-210">
    <Image
    ...
    <div className="w-full max-w-4xl mx-auto flex flex-col lg:flex-row lg:gap-10 gap-6 px-4 lg:px-2 py-16 lg:pt-40 lg:pb-30 relative -mt-55">
      {/* Textos à esquerda */}
      <div className="flex-1 flex flex-col justify-start items-start text-white  rounded-2xl lg:p-8 p-4 relative lg:-left-12 lg:mt-8">
...
/>
              ...
              <span className="font-light text-[0.7rem] lg:text-[15px] lg:leading-normal leading-none relative top-1 lg:top-0">
                Curso presencial<br />realizado apenas<br /><span className="font-medium ">2 vezes ao ano</span>
              </span>
            </div>

            {/* Bloco 2 */}
            <div className="relative flex flex-col items-center border border-[#c6ad7b] lg:rounded-2xl rounded-[0.5rem] px-0 py-3 lg:px-4 lg:py-6  w-full text-center">
...
/>
              ...
              <span className="font-light text-[0.7rem] lg:text-[15px] lg:leading-normal leading-none">
                2 dias.<br /><span className="font-medium ">1 dia de teoria +<br />1 dia de prática</span>
              </span>
            </div>
          </div>

        <p className="mb-3 lg:mt-5 lg:text-[1.05rem] font-light text-[0.85rem] lg:leading-snug leading-[1.1] lg:text-justify lg:mb-5.5 ">
        ...
        <p className="mb-4 lg:text-[1.066rem] text-[0.86rem] lg:leading-snug leading-[1.1] lg:text-justify font-light">
        ...
        <p className="mb-4 lg:text-[1.05rem] text-[0.85rem] lg:leading-snug leading-[1.1] lg:text-justify font-light">
        ...
        <p className="mb-2 lg:mb-4 lg:text-[1.08rem] text-[0.855rem] lg:leading-relaxed leading-[1.1] font-light">
        ...
        <p className="mb-2 lg:mb-4 lg:text-[1.08rem] text-[0.83rem] lg:leading-relaxed leading-[1.1] font-light">
        ...
        <p className="mb-4 lg:mb-4 lg:text-[1.08rem] text-[0.83rem] lg:leading-relaxed leading-[1.1] font-light">
    ...
    <h2 className="titulo-scotch text-[1.25rem] text-center lg:text-right lg:text-[2.45rem] font-normal lg:mb-10 mb-6 tracking-[-0.05rem] leading-none px-10 lg:px-0">ESPECIALIZAÇÃO <span className="lg:text-[2.45rem]  "></span>INTERNACIONAL</h2>
        <div className="flex  flex-row lg:gap-4 gap-24 lg:mb-12 mb-7 w-full justify-center px-8 lg:px-0 lg:pt-3">
            ...
            <div className="relative flex flex-col items-center border bg-[#3957a6] lg:rounded-2xl  rounded-[0.5rem] px-0 py-3.5 lg:px-4 lg:py-5 w-full lg:w-1/2 text-center -right-8 lg:-right-0">
              ...
              <span className="font-light text-[0.7rem] lg:text-[15px] text-white lg:leading-snug leading-[1.1]">
            ...
            <div className="relative flex flex-col items-center border bg-[#3957a6] lg:rounded-2xl rounded-[0.5rem] px-0 py-3 lg:px-4 lg:py-5 w-full lg:w-1/2 text-center -left-8 lg:-left-0">
              ...
              <span className=" text-[0.7rem] lg:text-[15px] text-white lg:leading-snug leading-[1.1] font-light">
                4 dias:<br /><span className="font-medium  ">2 dia de teoria +<br />2 dia de<br className="block lg:hidden" /> prática</span>
              </span>
            </div>
          </div>
...
<div className="px-4 lg:px-0">
        ...
        {/* Blocos destacados */}
        <p className="mb-5 text-[#3957a6] border border-[#3957a6]  lg:px-5  px-4 lg:py-2 py-1.5 text-center font-semibold lg:text-[14px] text-[0.75rem] leading-[1.1] lg:leading-normal">
          Prática em Fresh Frozen Cadáver (cadáveres frescos),
          garantindo precisão, segurança e realismo.
        </p>
        <p className="mb-6 text-[#3957a6] border border-[#3957a6]  lg:px-5 px-4  lg:py-2 py-1.5  text-center font-semibold lg:text-[14px] text-[0.75rem]  leading-[1.1] lg:leading-normal">
          Aulas teóricas e práticas conduzidas pessoalmente pela
          Dra. Hyllua Husein.
        </p>
        <p className="mb-4 text-[#3957a6] border border-[#3957a6]  lg:px-4 px-5 lg:py-2 py-1.5 text-center font-semibold lg:text-[14px] text-[0.75rem]  leading-[1.1] lg:leading-normal
        ">
...
<section className="bg-[#e8e8e9] relative overflow-hidden">
  <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 items-end lg:items-start  lg:px-12 pt-12  lg:pt-22 gap-8 z-2">
    ...
    <div className="col-span-1 flex flex-col lg:justify-center lg:items-start items-end lg:text-left text-right z-10 lg:top-30 lg:left-2 relative">
      <h2 className="text-[35px] lg:text-[70px] font-normal text-[#3957a6] leading-none titulo-scotch lg:mb-10 mb-3 ">
        Hyllua<br /> <span className="font-bold italic">Husein</span>
      </h2>

      <p className="text-[#3957a6] lg:text-[20px] text-[0.85rem] lg:leading-[1.45] leading-[1.1]  tracking-[3px] px-8 lg:px-0 relative -right-9 lg:-right-0" >
  ...
  {/* Logo atrás do texto e imagem */}
   ...
   {/* Nova Section Azul Degradê */}
      <section className="relative -mt-150 w-full flex  justify-center items-center px-4 lg:px-0 lg:pt-34 lg:pb-4 z-9 ">
        <Image
      ...
      <section className="w-full bg-[#eaeaea] lg:py-28 py-7 px-4 lg:px-0 flex items-center justify-center ">
        <div className="max-w-4xl w-full mx-auto flex flex-col lg:flex-row items-center lg:items-center justify-between gap-6 ">
          <div className="flex-1 flex items-center justify-center lg:justify-start">
            <p className="text-[#3957a6] text-[1.05rem] lg:text-[1.7rem] font-light text-center lg:text-left titulo-scotch lg:leading-none leading-snug">
