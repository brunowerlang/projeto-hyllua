        ...
        {procedimentos.map((item, index) => (
          <div key={index} className="!border-t !border-white" >
            ...
            <button
              ...
              className="w-full flex justify-between items-center lg:px-6 px-4  lg:py-3 py-2 bg-[#353a2c] text-white font-normal tracking-normal uppercase lg:text-[0.93rem] text-[0.66rem] "
              type="button"
            >
              {item.titulo}
              <span
